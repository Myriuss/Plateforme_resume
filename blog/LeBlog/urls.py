...
from .views import HomeView, PostDetailView, AddPostView, UpdatePostView, DeletePostView, AddCatView, CategoryView, CategoryListView, LikeView, ShowProfilePageView
#from . import views
